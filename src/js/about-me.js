...
function initAccordion() {
  ...
  Array.from(document.querySelectorAll('.a-m-accordion-el'))
...
function initKeyboardNavigation() {
  document.addEventListener('keydown', e => {
    if (e.key === 'ArrowRight') {
      const nextBtn = document.querySelector('.a-m-swiper-button-next');
      if (nextBtn) nextBtn.click();
    } else if (e.key === 'ArrowLeft') {
      const prevBtn = document.querySelector('.a-m-swiper-button-prev');
